...
Shader "Shader Forge/customLit" {
    Properties {
        ...
        [MaterialToggle] _Is_Vegetation ("Is_Vegetation?", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip(lerp( 1.0, _Diffuse_var.a, _Is_Vegetation ) - 0.5);
