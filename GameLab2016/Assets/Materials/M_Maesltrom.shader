...
Shader "Custom/NewSurfaceShader" {
    Properties {
        ...
        [MaterialToggle] _Invert_Diff ("Invert_Diff", Float ) = 0
...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,lerp( 1.0, (pow(lerp( (1.0 - node_172), node_172, _Invert_Mask ),_Black_Power)*_White_Power), _Use_Mask ));
